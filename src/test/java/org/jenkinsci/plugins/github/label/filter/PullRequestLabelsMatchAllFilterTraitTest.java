...
public class PullRequestLabelsMatchAllFilterTraitTest {
    ...
    public void testMatchAll() throws IOException, InterruptedException {
        ...
        SCMHeadFilter scmHeadFilter = new PullRequestLabelsMatchAllFilterTrait("label1,label2").getScmHeadFilter();
    ...
    public void testMatchSome() throws IOException, InterruptedException {
        when(ghPullRequest.getLabels()).thenReturn(Arrays.asList(ghLabel1, ghLabel2));
        SCMHeadFilter scmHeadFilter = new PullRequestLabelsMatchAllFilterTrait("label3,label4").getScmHeadFilter();
        boolean isExcluded = scmHeadFilter.isExcluded(gitHubSCMSourceRequest, pullRequestSCMHead);
